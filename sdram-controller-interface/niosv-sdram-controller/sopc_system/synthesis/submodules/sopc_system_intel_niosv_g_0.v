...
`timescale 1 ps / 1 ps
module sopc_system_intel_niosv_g_0 (
	...
	sopc_system_intel_niosv_g_0_hart #(
		...
		.TIMER_MSIP_DATA_S_BASE   (32'b00000000000001010000000000000000),
		.DTCM1_SIZE               (0),
	...
	sopc_system_intel_niosv_g_0_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	sopc_system_intel_niosv_g_0_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	sopc_system_intel_niosv_g_0_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
